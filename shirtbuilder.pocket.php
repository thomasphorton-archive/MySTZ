...
<div id="pageWrapper" class="shirtMaker">
  ...
  <h3 style="color:white; text-align:center;">$35</h3>
  	<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
			...
			<input type="image" src="images/addToCart.png" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" onclick="_gaq.push(['_trackEvent', 'ShirtBuilder', 'Add Pocket to Cart', 'Details to Be Added');">
			</div>
