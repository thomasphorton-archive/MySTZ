...
$(function(){
	...
	var ttToggle = $('.two-tone-toggle');

	ttToggle.click(function(){
		ttToggle.removeClass('is-active');
	...
	<div class="row">
		<div class="shirtMaker simpleCart_shelfItem span12">
			<div class="row">
			    ...
			    <div class="slider">
			    	<div id="pocketTops" class="flexslider pocketTopsSlide">
			      	<ul class="slides">
			        	
			            <li><img src="/images/shirtbuilder/pockets/pockettops/flamingo.top.png" alt="foobar" class=" lazy" /></li>
				...
				<div class="span7 pull-right">
				  <div class="flex-container shirtmaker-step row" id="designContainer">
				  	<h1 class="item_name"><?=$item_name?></h1>
						...
						<label for="two-tone-pocket"><input type="checkbox" name="two-tone-pocket" id="two-tone-pocket">Two-Tone Pocket Mode</label>
					  <span class="btn two-tone-toggle two-tone-primary is-active">Choose Primary Pocket</span>
					  <span class="btn two-tone-toggle two-tone-secondary">Choose Secondary Pocket</span>
					  <div id="designThumb" class="row is-primary">
