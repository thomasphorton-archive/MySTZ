...
<div class="container">
	<div class="row">
		<div class="span12">
			<span class="breadCrumb"><a href="index.php">home</a> > <a href="products.php">products</a> > <a href="products.tanks.php">tanks</a> > Women's Flow Tank</span>
		</div>
	</div>
	<div class="row">
		<img src="images/tanks/tanks.flow.main.jpg" class="span9">
		<div class="span3">
			<div class="product-data simpleCart_shelfItem">
				<span class="item_number" style="display:none;">1114</span>
				<span class="item_description tank-description" style="display:none;"></span>
				<h1 class="product-title item_name">Women's Flow Tank</h1>
				...
				<select name="tank-color" id="tank-color">
					...
					<option value="HTHR Grey / White">HTHR Grey / White </option>
					<option value="HTHR Grey / Neon Pink">HTHR Grey / Neon Pink </option>
				</select>
